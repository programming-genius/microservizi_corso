package it.app.registration.security;

import it.app.registration.component.JWTAuthenticationProvider;
import it.app.registration.filter.JwtAuthenticationFilter;
...
public class ProjectConfigSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        http.addFilterBefore(authenticationFilter(), BasicAuthenticationFilter.class).
				authorizeRequests().
				antMatchers("/registration").hasAnyAuthority("Client","Admin").
