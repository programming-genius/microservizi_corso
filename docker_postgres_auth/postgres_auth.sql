...
COPY public.role (id, name, version) FROM stdin;
1	Admin	0
\.
...
COPY public."user" (username, password, id, algorithm, version) FROM stdin;
John	{bcrypt}$2a$10$ER3fAsOF5NdfMs0RjJtHAOUmWD9/JU1bmgklIqWOeEJ3r2Rwc2Nk6	1	BCRYPT	0
\.
